...
TEST_CASE("UpdateTrans chains parent * child local transforms") {
    auto parent = std::make_shared<SceneNode>(Vector3f(10.f, 0.f, 0.f),
                                              Vector3f(1.f, 1.f, 1.f),
                                              Vector3f(0.f, 0.f, 0.f));
    auto child  = std::make_shared<SceneNode>(Vector3f(2.f, 3.f, 0.f),
                                             Vector3f(1.f, 1.f, 1.f),
                                             Vector3f(0.f, 0.f, 0.f));
...
TEST_CASE("UpdateTrans after MarkTransDirty recomputes") {
    auto p = std::make_shared<SceneNode>(Vector3f(1.f, 0.f, 0.f),
                                         Vector3f(1, 1, 1),
                                         Vector3f(0, 0, 0));
    auto c = std::make_shared<SceneNode>(Vector3f(0, 0, 0),
                                         Vector3f(1, 1, 1),
                                         Vector3f(0, 0, 0));
    p->AppendChild(c);
    c->UpdateTrans();
...
TEST_CASE("CopyTransWithParent also reparents") {
    auto parent = std::make_shared<SceneNode>(Vector3f(10.f, 0.f, 0.f),
                                              Vector3f(1, 1, 1),
                                              Vector3f(0, 0, 0));
    auto src    = std::make_shared<SceneNode>(Vector3f(1.f, 0.f, 0.f),
                                           Vector3f(1, 1, 1),
                                           Vector3f(0, 0, 0));
...
TEST_CASE("InheritParent keeps local transform, inherits parent chain") {
    auto parent = std::make_shared<SceneNode>(Vector3f(100.f, 0.f, 0.f),
                                              Vector3f(1, 1, 1),
                                              Vector3f(0, 0, 0));
    auto src    = std::make_shared<SceneNode>(Vector3f(0, 0, 0),
                                           Vector3f(1, 1, 1),
                                           Vector3f(0, 0, 0));
    parent->AppendChild(src);
...
TEST_CASE("SetParent wires the transform chain") {
    auto parent = std::make_shared<SceneNode>(Vector3f(3.f, 0.f, 0.f),
                                              Vector3f(1, 1, 1),
                                              Vector3f(0, 0, 0));
...
TEST_CASE("MarkTransDirty propagates to descendants") {
    auto p = std::make_shared<SceneNode>();
    auto k = std::make_shared<SceneNode>(Vector3f(1, 0, 0), Vector3f(1, 1, 1), Vector3f(0, 0, 0));
    p->AppendChild(k);
